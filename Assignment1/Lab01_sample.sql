...
--
SPOOL D:\WORK\2714\Lab01_sample.txt
--
-- ---------------------------------------------------------
...
--  Lastname, Firstname    A001234567
--  email: firstname_lastname@bcit.ca
--
-- ---------------------------------------------------------
...
,CONSTRAINT FKProdNo 
   FOREIGN KEY (ProdNo) 
     REFERENCES Product       -- (ProdNo) Optional
);
--
...
-- Insert Product Data
INSERT INTO Product
  VALUES ('P1445671','Color Laser Printer','Intersafe',
          33,14.99,NULL);
-- Insert Order Data
INSERT INTO OrderTbl
  VALUES ('O1116324',DATE'2018-01-23','C0954327');
